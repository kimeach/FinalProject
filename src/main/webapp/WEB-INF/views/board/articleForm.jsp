...
<form name="articleForm" method="post" action="${contextPath}/board/addNewArticle.do" enctype="multipart/form-data">
    <table border="1" align="center">
      <tr>
		...
		<td colspan=2  align="left"><input type="text" size="64" maxlength="100"  value="${member.id}" name="id" disabled/>
												 <input type="hidden" size="64" maxlength="100"  value="${member.id}" name="id"/></td> <!-- readonly는 값 넘어감, disabled는 X -->
		<!-- <td colspan=2  align="left"><input type="text" size="64" maxlength="100"  name="id"/></td> -->
		<%-- <td colspan=2  align="left"><input type="text" size="64" maxlength="100"  name="id"value="${article.id}" readonly /></td> --%>
	</tr>
	<tr>
